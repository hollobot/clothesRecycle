/*
 ...
 Source Server         : aliyun-hello
 Source Server Type    : MySQL
 Source Server Version : 80045
 Source Host           : 8.136.30.123:3306
...
CREATE TABLE `RECOVER_YOUR_DATA_info`  (
  `READ_ME` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of RECOVER_YOUR_DATA_info
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '收藏表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of favorite
-- ----------------------------
INSERT INTO `favorite` VALUES (14, 2, 21, '2026-04-27 11:39:33', '2026-04-27 11:39:33', 0);
INSERT INTO `favorite` VALUES (15, 2, 16, '2026-04-27 11:39:37', '2026-04-27 11:39:37', 0);
INSERT INTO `favorite` VALUES (16, 1, 22, '2026-04-27 11:39:57', '2026-04-27 11:39:57', 0);
...
-- Records of gift
-- ----------------------------
INSERT INTO `gift` VALUES (1, '环保帆布袋', '校园联名环保帆布袋', 'http://8.136.30.123:9000/clothes-recycle/item/708d9923-8f6b-4f2f-8b49-bdadb3901f86.png', 120, 99, 1, 1, '2026-03-22 14:01:53', '2026-04-27 11:27:40', 0);
INSERT INTO `gift` VALUES (2, '不锈钢保温杯', '保温杯 480ml', 'http://8.136.30.123:9000/clothes-recycle/item/f2410a31-672b-4d7b-849f-26f356d5662a.jpg', 260, 79, 1, 1, '2026-03-22 14:01:53', '2026-04-27 11:27:42', 0);
INSERT INTO `gift` VALUES (3, '电风扇', '电风扇', 'http://8.136.30.123:9000/clothes-recycle/item/9ae836bd-159b-4aaa-a543-9af97d7bff21.avif', 10, 9, 1, 1, '2026-03-24 12:29:02', '2026-04-27 11:27:55', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '物品表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `item` VALUES (21, 1, 1, '帆布袋', '配饰', '通用', 'M', '九成新', '帆布袋', 'http://8.136.30.123:9000/clothes-recycle/item/25cc2182-2920-4cb8-a31e-2a1381349bb1.png', 'POINT', 18, 'ON_SHELF', '审核通过', '2026-03-24 12:43:55', '2026-04-27 11:28:08', 0);
INSERT INTO `item` VALUES (22, 2, 1, '休闲外套', '上装', '通用', 'M', '九成新', '休闲外套（测试数据）', 'http://8.136.30.123:9000/clothes-recycle/item/b8c785b9-cba2-494d-96bd-97f4d36737fe.jpg', 'POINT', 100, 'ON_SHELF', '审核通过', '2026-04-27 11:39:09', '2026-04-27 11:39:09', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '物品图片表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `item_image` VALUES (46, 21, 'http://8.136.30.123:9000/clothes-recycle/item/25cc2182-2920-4cb8-a31e-2a1381349bb1.png', 0, '2026-03-24 12:43:55', '2026-04-27 11:28:18', 0);
INSERT INTO `item_image` VALUES (47, 22, 'http://8.136.30.123:9000/clothes-recycle/item/b8c785b9-cba2-494d-96bd-97f4d36737fe.jpg', 0, '2026-04-27 11:39:09', '2026-04-27 11:39:09', 0);
INSERT INTO `item_image` VALUES (48, 22, 'http://8.136.30.123:9000/clothes-recycle/item/3f237859-f2ea-41f2-b33d-06b0269c9df3.jpg', 1, '2026-04-27 11:39:09', '2026-04-27 11:39:09', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '站内消息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `message` VALUES (48, 2, '物品审核结果', '审核已通过', 'AUDIT', 0, '2026-04-27 11:39:21', '2026-04-27 11:39:21', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 54 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '积分流水表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `point_record` VALUES (53, 2, 30, 'ITEM_AUDIT_PASS', 22, '物品审核通过奖励', '2026-04-27 11:39:21', '2026-04-27 11:39:21', 0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '13203071697', '123456', '2024021575', 'hello', 1, 'http://8.136.30.123:9000/clothes-recycle/item/1115aa25-d8ad-4a9b-9e4c-4c15986575e7.jpg', 1871, 0, 1, '2026-03-23 10:03:35', '2026-04-27 11:32:59', 0);
INSERT INTO `user` VALUES (2, '13203071698', '123456', '2024021576', '测试', 2, '', 671, 0, 1, '2026-03-23 14:35:15', '2026-03-23 14:35:15', 0);
